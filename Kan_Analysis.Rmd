...
outcome_neutral_sentence_data$sentence_plot
```
...
```{r}
ggsave("Figures/Kan_Exp2_Rt_Cse_Rev_Plot.png", width = 14.4, height = 8, plot = last_plot())
```
...
```{r}
ggsave("Figures/Kan_Exp2_Rt_Cse_Plot.png", width = 14.4, height = 8, plot = last_plot())
```
...
```{r}
ggsave("Figures/Kan_Exp2_Correlation_Plot.png", width = 14.4, height = 8, plot = last_plot())
```
