...
# TODO: for some participants starting with 3018 the dataset is different and word_no and sentence_id is missing why? for most sentences it is present once but sometimes not
```{r}
neutral_analysis_sentence <-
  neutral_analysis_sentence %>% 
...
Now we fit the model to the inconguent sentences to calculate the predicted reading time.
